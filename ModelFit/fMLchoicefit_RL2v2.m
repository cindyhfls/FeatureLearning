function loglikehood = fMLchoicefit_RL2v2(xpar, sesdata)
%
...
xpar([NparamBasic+1:NparamBasic+sesdata.Nalpha*nChops])=1./(1+exp(-(xpar([NparamBasic+1:3+sesdata.Nalpha*nChops]))./sesdata.sig) ) ;
